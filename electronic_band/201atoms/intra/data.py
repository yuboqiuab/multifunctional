...
class CrystalGraphDataset(Dataset):
    ...
    def _get_edge_and_face(self, struc, hoppings,fid):
        ...
        f51 = open('inputss1sgap_'+fid, 'w');
        f52 = open('inputss2sgap_'+fid, 'w');
        f53 = open('outputssgap_'+fid, 'w');
        f54 = open('vectorssgap_'+fid,'w')
        f55 = open('indexssgap_'+fid,'w')
