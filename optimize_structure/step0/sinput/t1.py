   ...
   #         f2.write("%12.10f  %12.10f  %12.10f  %12.10f\n" % (c[33][i][0],c[33][i][1],c[33][i][2],c[33][i][3]))
        ...
        for ai in range(int(num/3),num):
            ...
            for ti in range(len(input)):
                ...
                xyz[0]=input[ti][1]/input[ti][0]/input[ti][0]
                xyz[1]=input[ti][2]/input[ti][0]/input[ti][0]
                xyz[2]=input[ti][3]/input[ti][0]/input[ti][0]
                pxyz=lattice.get_fractional_coords(xyz)
                f2.write("%12.10f   %12.10f   %12.10f\n" % (pxyz[0],pxyz[1],pxyz[2]))
